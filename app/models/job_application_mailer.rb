class JobApplicationMailer < ActionMailer::Base
  ...
  def job_application_sent_to_company(job_application)
   ...
   # content_type "multipart/alternative"
    ...
    unless job_application.resume.path.nil? or job_application.resume.path.blank? then
    ...
    unless job_application.portfolio.path.nil? or job_application.resume.path.blank? then
